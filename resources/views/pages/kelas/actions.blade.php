<div class="btn-group gap-2">
  @if (Auth::user()->role == 'super_admin')
    <a href="{{ route('kelas.edit', $row->id) }}" class="btn btn-primary btn-sm"><i class="ti-pencil-alt"></i></a>
  ...
  @else
    <a href="{{ route('admin.kelas.edit', $row->id) }}" class="btn btn-primary btn-sm"><i class="ti-pencil-alt"></i></a>
